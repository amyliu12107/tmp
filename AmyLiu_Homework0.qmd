...
Currently, this plot shows the quadratic function $$ f(x) = \alpha x^2 + \beta x + c $$ for a = 1, b = 3, c = 2. The green line is the quadratic function, the blue line is the x-axis, and the red dotted line(s) and point(s) that intersect with the black and blue is/are the solutions. Depending on if you change a, b, and/or c, there might be 0, 1, or 2 red dotted line(s) and point(s). 
